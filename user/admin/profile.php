...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="fontawesome.html" class="waves-effect"><i class="fa fa-font fa-fw" aria-hidden="true"></i>Edit Package</a>
                    </li>
                    <li>
                        <a href="create_user.php" class="waves-effect"><i class="fa fa-globe fa-fw" aria-hidden="true"></i>Add Admin</a>
                    </li>
                    <li>
                        <a href="blank.html" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Comments</a>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form method="post" action="../controller/Admincont.php" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="name" value="<?php echo $admind["username"]?>"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input type="email" placeholder="" value="<?php echo $admind["email"]?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  value="<?php echo $admind["phoneno"]?>" name="phone" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">User Type</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" value="<?php echo $admind["user_type"]?>"
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2020 &copy; Travel Agency brought to you by AK</footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
